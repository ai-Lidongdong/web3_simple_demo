...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../common.ts"
  ...
  export interface TokenCInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface TokenC extends BaseContract {
    
    connect(runner?: ContractRunner | null): TokenC;
    waitForDeployment(): Promise<this>;

    interface: TokenCInterface;
