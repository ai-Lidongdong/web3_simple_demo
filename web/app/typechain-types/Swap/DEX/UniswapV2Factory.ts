...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.ts"
  ...
  export interface UniswapV2FactoryInterface extends Interface {
    getFunction(nameOrSignature: "allPairs" | "allPairsLength" | "createPair" | "getPair"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'getPair', data: BytesLike): Result;
    ...
    export namespace PairCreatedEvent {
      export type InputTuple = [token0: AddressLike, token1: AddressLike, pair: AddressLike, arg3: BigNumberish];
      export type OutputTuple = [token0: string, token1: string, pair: string, arg3: bigint];
      export interface OutputObject {token0: string, token1: string, pair: string, arg3: bigint };
